  ...
  if(!feed || feed.length===0) return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4 animate-fade-in">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-3xl font-bold text-secondary mb-3 dark:text-gray-100">No More Users</h2>
        <p className="text-secondary-lighter text-lg leading-relaxed dark:text-gray-300">You've seen all available developers! Check back later for new connections.</p>
      </div>
    </div>
  )
