        ...
        <div className="card-modern overflow-hidden w-full max-w-md mx-auto group">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              {isConnected ? (
              ...
              ) : requestStatus === 'interested' && sentBy === 'them' ? (
                // Accept/Decline
                <>
                  <button
              ...
              ) : requestStatus === 'interested' && sentBy === 'me' ? (
                ...
                <>
                  ...
                  <button
                    ...
                    disabled
                    aria-label="Connection request already sent"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {!isConnected && !(requestStatus === 'interested' && sentBy === 'them') && (
              <button
                onClick={handleStartChat}
                disabled={isCreatingChat}
